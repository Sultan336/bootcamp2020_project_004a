  ...
  return (
    <Fragment>
      <div class="buttons">
        ...
        >
          {!added["spinach"] ? "Add Spinach" : "Remove Spinach"}
        </button>
        <button
          onClick={() => doAnimation("mushroom")}
          className="mushroom-button"
        >
          {!added["mushroom"] ? "Add Mushrooms" : "Remove Mushrooms"}
        </button>
        <button
          onClick={() => doAnimation("pepperoni")}
          className="pepperoni-button"
        >
          {!added["pepperoni"] ? "Add Pepperoni" : "Remove Pepperoni"}
        </button>
      </div>
